...
This assumes that you already have compiled FAST.Farm binaries. If not you can download them [here](https://github.com/OpenFAST/openfast/releases/tag/v5.0.0). This interface has been tested with **FAST.Farm v5.0.0** (upgraded from v3.5.1).
...
By default, your FAST.Farm executable is assumed to be located in `wfcrl/simulators/fastfarm/bin/FAST.Farm_x64_OMP.exe`. If not, you can also pass it to the interface:
