...
class FlorisCase(FarmCase):
    ...
    def simul_params(self):
        ...
        if self.turbine_type is not None:
            params["turbine_type"] = self.turbine_type
        if self.turbine_library_path is not None:
            params["turbine_library_path"] = self.turbine_library_path
        return params
...
ycoords = [
    1990.3730449999998, 1945.447252, 1897.3124750000002, 1839.550742,
...
# fmt: off
xcoords = [
    3378.3280896, 4347.000730399999, 5287.63824580002, 6245.1108866000095,
...
ycoords = [
    6514.8637897997005, 7132.538836799939, 7762.2424016000205, 8388.74596620019,
...
# DafengH1 wind farm layout
# 24 turbines - Goldwind 8.5MW - Dafeng H1 Project
# UTM coordinates converted to relative coordinates (origin at min x, center y)
# fmt: off
xcoords = [
    6.206, 939.84, 1955.816, 2995.663, 4002.738, 5434.417, 6387.486,
    0.0, 17.343, 267.999, 1128.129, 2282.239, 3436.35, 4590.461,
    5744.571, 6612.689, 6754.058, 518.655, 1544.285, 2569.916,
    3595.546, 4621.176, 5646.806, 7051.284,
]
ycoords = [
    2162.469, 2158.897, 2158.263, 2156.617, 2156.044, 2153.971, 2153.41,
    1103.544, 44.08, -1015.383, 45.825, 47.57, 49.314, 51.059,
    52.804, 753.797, -644.7, -2074.846, -2069.661, -2064.475,
    -2059.289, -2054.103, -2048.917, -2162.469,
]
# fmt: on
fastfarm_DafengH1 = FastFarmCase(
    num_turbines=len(xcoords),
    xcoords=xcoords,
    ycoords=ycoords,
    dt=3,
...
floris_DafengH1.turbine_type = ["goldwind_8_5mw_calibrated"]
floris_DafengH1.turbine_library_path = None  # Resolved at runtime by create_floris_case
...
named_cases_dictionary = {
    ...
    "DafengH1_": [fastfarm_DafengH1, floris_DafengH1],
}
